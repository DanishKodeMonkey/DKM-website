...
const Portfolio: React.FC = () => {
  ...
  const fetchFeaturedRepos = async () => {
    try {
      const featuredRepoNames = ["odin-file-uploader", 'coffee-lovers-club-postgresql', 'odin-inventory-application-postgreSQL']
      ...
      setFeaturedRepos(fetchedFeaturedRepos.filter((repo): repo is Repo => repo !== null));
    } catch (err) {
